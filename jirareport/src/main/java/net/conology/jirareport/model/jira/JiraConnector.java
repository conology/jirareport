...
public class JiraConnector {
	 ...
	 * 
	 * AsynchronousJiraRestClientFactory async = new
	 * AsynchronousJiraRestClientFactory(); AuthenticationHandler handle = new
	...
	private SearchResult getIssuesOfSprint() {
		// return restClient.getSearchClient().searchJql("Sprint in openSprints() AND
		// Sprint not in futureSprints()").claim();
